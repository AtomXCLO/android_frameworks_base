...
public final class PowerManagerService extends SystemService
    ...
    // Power features defined in vendor/atomx/interfaces/power/vendor/atomx/power/Feature.aidl.
    ...
    public static class NativeWrapper {
        ...
        /** Wrapper for PowerManager.nativeSetAtomXFeature */
        public void nativeSetAtomXFeature(int featureId, int data) {
            PowerManagerService.nativeSetAtomXFeature (featureId, data);
        }
    ...
    private static native void nativeSetAtomXFeature(int featureId, int data);
    ...
    PowerManagerService(Context context, Injector injector) {
        ...
        synchronized (mLock) {
            ...
            mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_GESTURES, 0);
            mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_DOUBLE_TAP, 0);
            mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_DRAW_V, 0);
            mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_DRAW_INVERSE_V, 0);
            mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_DRAW_O, 0);
            mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_DRAW_M, 0);
            mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_DRAW_W, 0);
            mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_DRAW_S, 0);
            mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_DRAW_ARROW_LEFT, 0);
            mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_DRAW_ARROW_RIGHT, 0);
            mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_ONE_FINGER_SWIPE_UP, 0);
            mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_ONE_FINGER_SWIPE_RIGHT, 0);
            mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_ONE_FINGER_SWIPE_DOWN, 0);
            mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_ONE_FINGER_SWIPE_LEFT, 0);
            mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_TWO_FINGER_SWIPE, 0);
            mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_SINGLE_TAP, 0);
    ...
    private void updateSettingsLocked() {
        ...
        if (gesturesEnabled != mGesturesEnabled) {
            ...
            mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_GESTURES,
        ...
        if (mSupportsDoubleTapConfig) {
            ...
            if (doubleTapEnabled != mDoubleTapEnabled) {
                ...
                mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_DOUBLE_TAP,
        ...
        if (mSupportsSingleTapConfig) {
            ...
            if (singleTapEnabled != mSingleTapEnabled) {
                ...
                mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_SINGLE_TAP,
        ...
        if (mSupportsDrawVConfig) {
            ...
            if (drawVEnabled != mDrawVEnabled) {
                ...
                mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_DRAW_V,
        ...
        if (mSupportsDrawInverseVConfig) {
            ...
            if (drawInverseVEnabled != mDrawInverseVEnabled) {
                ...
                mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_DRAW_INVERSE_V,
        ...
        if (mSupportsDrawOConfig) {
            ...
            if (drawOEnabled != mDrawOEnabled) {
                ...
                mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_DRAW_O,
        ...
        if (mSupportsDrawMConfig) {
            ...
            if (drawMEnabled != mDrawMEnabled) {
                ...
                mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_DRAW_M,
        ...
        if (mSupportsDrawWConfig) {
            ...
            if (drawWEnabled != mDrawWEnabled) {
                ...
                mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_DRAW_W,
        ...
        if (mSupportsDrawSConfig) {
            ...
            if (drawSEnabled != mDrawSEnabled) {
                ...
                mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_DRAW_S,
        ...
        if (mSupportsDrawArrowLeftConfig) {
            ...
            if (drawArrowLeftEnabled != mDrawArrowLeftEnabled) {
                ...
                mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_DRAW_ARROW_LEFT,
        ...
        if (mSupportsDrawArrowRightConfig) {
            ...
            if (drawArrowRightEnabled != mDrawArrowRightEnabled) {
                ...
                mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_DRAW_ARROW_RIGHT,
        ...
        if (mSupportsOneFingerSwipeUpConfig) {
            ...
            if (oneFingerSwipeUpEnabled != mOneFingerSwipeUpEnabled) {
                ...
                mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_ONE_FINGER_SWIPE_UP,
        ...
        if (mSupportsOneFingerSwipeRightConfig) {
            ...
            if (oneFingerSwipeRightEnabled != mOneFingerSwipeRightEnabled) {
                ...
                mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_ONE_FINGER_SWIPE_RIGHT,
        ...
        if (mSupportsOneFingerSwipeDownConfig) {
            ...
            if (oneFingerSwipeDownEnabled != mOneFingerSwipeDownEnabled) {
                ...
                mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_ONE_FINGER_SWIPE_DOWN,
        ...
        if (mSupportsOneFingerSwipeLeftConfig) {
            ...
            if (oneFingerSwipeLeftEnabled != mOneFingerSwipeLeftEnabled) {
                ...
                mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_ONE_FINGER_SWIPE_LEFT,
        ...
        if (mSupportsTwoFingerSwipeConfig) {
            ...
            if (twoFingerSwipeEnabled != mTwoFingerSwipeEnabled) {
                ...
                mNativeWrapper.nativeSetAtomXFeature(POWER_FEATURE_TWO_FINGER_SWIPE,
